...
<!-- <center>  
 ...
 -->
<center>  <button type="submit" name="btnYa" class="btnPilihanYa" ><i class="fa fa-check"></i> YA</button>
  <button type="submit" name="btnNo" class="btnPilihanNo"><i class="fa fa-close"></i> TIDAK</button></center>
  </div>
